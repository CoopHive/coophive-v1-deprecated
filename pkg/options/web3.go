...
func GetDefaultWeb3Options() web3.Web3Options {
	return web3.Web3Options{
		...
		// core settings
		RpcURL:     GetDefaultServeOptionString("WEB3_RPC_URL", "ws://halcyon.co-ophive.network:8546"),
		PrivateKey: GetDefaultServeOptionString("WEB3_PRIVATE_KEY", ""),
		ChainID:    GetDefaultServeOptionInt("WEB3_CHAIN_ID", 1337), //nolint:gomnd

		// contract addresses
		ControllerAddress: GetDefaultServeOptionString("WEB3_CONTROLLER_ADDRESS", "0x88B4F47bE05B2531c3F5d0aA41eFb96394a279CF"),
